...
<?php include('partials-front/menu.php'); ?>
    ...
    <section class="food-search">
        <div style="    background-color: rgba(0, 0, 0, 0.664);
" >
        <div class="container">
            ...
            <form action="" method="POST" class="order">
                ...
                <fieldset>
                    ...
                    <input type="text" name="full-name" placeholder="Abd elfattah" class="input-responsive" required>

                    <div class="order-label">Phone Number</div>
                    <input type="tel" name="contact" placeholder="E.g. 0643xxxxxx" class="input-responsive" required>
            ...
            <?php 
                ...
                if(isset($_POST['submit']))
                {
                    ...
                    if($res2==true)
                    {
                        ...
                        header('location:'.'http://localhost:81/happy_food/');
                    }
                    else
                    {
